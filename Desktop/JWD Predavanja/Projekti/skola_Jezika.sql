...
INSERT INTO `pohadja` VALUES (1,1),(13,1),(1,2),(3,2),(13,2),(2,3),(1,5),(2,5),(3,5),(4,5),(5,5),(13,5);
...
CREATE TABLE `uplate` (
  ...
  PRIMARY KEY (`ucenik_id`,`kurs_id`),
  KEY `kurs_id` (`kurs_id`),
  CONSTRAINT `uplate_ibfk_1` FOREIGN KEY (`ucenik_id`) REFERENCES `ucenik` (`id`),
  CONSTRAINT `uplate_ibfk_2` FOREIGN KEY (`kurs_id`) REFERENCES `kurs` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `uplate` VALUES (1,1),(1,2),(2,2),(3,3),(4,3);
...
-- Dump completed on 2018-05-09  2:59:59
